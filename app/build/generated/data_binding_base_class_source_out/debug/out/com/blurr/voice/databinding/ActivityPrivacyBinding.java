...
public final class ActivityPrivacyBinding implements ViewBinding {
  ...
  private ActivityPrivacyBinding(@NonNull CoordinatorLayout rootView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityPrivacyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPrivacyBinding((CoordinatorLayout) rootView, toolbar);
    }
